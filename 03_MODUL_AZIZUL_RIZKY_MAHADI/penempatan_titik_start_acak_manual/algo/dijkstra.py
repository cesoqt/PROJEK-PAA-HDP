...
## 4. ini jelaskan fungsi snap klik ke jalan, ini penting karena kita ingin memastikan bahwa titik yang dipilih oleh pengguna berada di jalan,
# bukan di tempat lain. Fungsi ini akan mencari titik terdekat di jalan berdasarkan koordinat yang diklik oleh pengguna.
